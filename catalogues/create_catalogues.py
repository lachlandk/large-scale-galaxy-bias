...
if __name__ == "__main__":
    ...
    for lim in mag_limits:
        ...
        print("Plotting map...")
        plot_catalogue(f"data_catalogue_r={lim}_m=0_z=0.2-0.5.hdf5", f"data_catalogue_r={lim}_m=0_z=0.2-0.5.png")
    ...
    for lim in mass_limits:
        ...
        print(f"Created catalogue of size {np.sum(catalogue)}. Elapsed time: {datetime.now() - start_time}")
        print("Plotting map...")
        plot_catalogue(f"data_catalogue_r=19.5_m={lim}_z=0.2-0.5.hdf5", f"data_catalogue_r=19.5_m={lim}_z=0.2-0.5.png")
        print(f"Map plotted, elapsed time: {datetime.now() - start_time}")
