...
if __name__ == "__main__":
    ...
    z_bins = 11
    z_lims = [0, 1]
    mag_lims = [19, 20, 21, 19.5, 19.5, 19.5, 19.5]
    mass_lims = [0, 0, 0, 9.5, 10, 10.5, 11]
    create_data_catalogue(lightcone_dir, files, z_bins, z_lims, mag_lims, mass_lims, save_name="data_catalogue.hdf5")
