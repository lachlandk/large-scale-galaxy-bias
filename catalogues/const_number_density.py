...
def create_catalogue(lightcone_dir, files, filename, rsd=False):
    ...
    total_galaxies, fixed_number_density, median_z = select_galaxies(lightcone_dir, files, filename, "0.45<z<0.5", z_lims=(0.45, 0.5), mass_lims=(11, np.inf), dec_lims=(30, 90), rsd=rsd)
